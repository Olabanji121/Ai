...
const handleSubmit =async(e)=>{
  ...
  if(form.prompt && form.photo && form.name){
    ...
    try {
      const response  = await fetch('http://35.89.21.236:8080/api/v1/post', {
        method: 'POST',
        headers:{
          'Content-Type': 'application/json'
        },
...
Create
        ...
        <p className='mt-2 text-[#666e75] text=[16px max-w-[500px]] font-Lato'>
         Create imaginative and visually stunning images generated by DALL_E AI and share them with the community
        </p>
      </div>
...
{ form.name && form.prompt && form.photo &&  <button
  type='submit'
